...
def test_eat():
    ds = Dots(600, 600, 150, 450, 150, 450)
    ds.eat(75, 450)
    assert len(ds.bottom_row) == ds.WIDTH//ds.SPACING + 1 - 1
    # test for the dot located at the intersection
    ds = Dots(600, 600, 150, 450, 150, 450)
    ds.eat(150, 150)
    assert len(ds.top_row) == ds.WIDTH//ds.SPACING + 1 - 1
    assert len(ds.left_col) == ds.HEIGHT//ds.SPACING + 1 - 1
    # test for the edge cases
    ds = Dots(600, 600, 150, 450, 150, 450)
    ds.eat(0, 450)
    assert len(ds.bottom_row) == ds.WIDTH//ds.SPACING + 1 - 2
    ds = Dots(600, 600, 150, 450, 150, 450)
    ds.eat(450, 600)
    assert len(ds.right_col) == ds.HEIGHT//ds.SPACING + 1 - 2
