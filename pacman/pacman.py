...
class Pacman(GameCharacter):
    ...
    def update(self):
        ...
        # if the mouth is entirely opened, make open_close a positive value
        # to let the mouth close
        if (self.mouth_angle > self.max_mouth_angle):
            self.open_close = -(self.mouth_speed)
        # if the mouth is closed, make open_close a negative value
        # to let the mouth open
